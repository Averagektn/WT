...
Информация о предметной области должна хранится в
БД:
...
Документацию к проекту необходимо оформить согласно требованиям javadoc Оформление кода должно соответствовать Java Code Convention
...
### Система Заказ фильмов
Клиент заказывает и оплачивает фильм. Оставляет отзывы о Фильме. Администратор добавляет новые фильмы, корректирует информацию о существующих, управляет клиентами, назначая им бонусы, скидки и пр.
---
## Lab №3
Приложение реализовать применяя технологии SpringCore, Spring MVC, Hibernate.
